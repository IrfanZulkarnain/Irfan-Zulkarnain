            ...
            <div class="py-6">
                <div class="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-5xl">
                    ...
                    <div class="w-full p-8 lg:w-1/2">
                        <h2 class="text-2xl font-semibold text-center text-gray-700">MyHomestay</h2>
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <a href="{{ route('users.create') }}" class="text-xs text-gray-500 uppercase">or <u>sign up here</u></a>
                            <span class="w-1/5 border-b md:w-1/4"></span>
                        </div>
                    </div>
                </div>
