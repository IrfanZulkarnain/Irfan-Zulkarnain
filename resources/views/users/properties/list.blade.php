    ...
    <div class="p-4 divide-y-2">
        <div class="p-4 mx-auto max-w-7xl">
            <div class="flex items-center space-x-2 text-sm text-gray-400">
                ...
                <a href="#" class="hover:underline hover:text-gray-600">My Homestays</a>
            </div>
        </div>
                    ...
                    <div class="px-4 md:flex-1">
                        ...
                        <div class="flex py-4 space-x-4">
                            <button type="button"
                                ...
                                <a href="{{ route('properties.show', $property->id) }}" name="" value="">See More</a>
                            </button>
                            <button type="button"
                                class="px-6 py-2 font-semibold text-white bg-indigo-600 h-14 rounded-xl hover:bg-indigo-500">
                                <a href="{{ route('properties.edit', $property->id) }}" name="" value="">Update</a>
                            </button>
                        </div>
                    </div>
                </div>
